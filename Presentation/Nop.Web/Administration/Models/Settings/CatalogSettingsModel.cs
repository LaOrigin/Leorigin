...
namespace Nop.Admin.Models.Settings
{
    public partial class CatalogSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.BookedPrice")]
        public decimal BookedAmount { get; set; } 
        public decimal BookedAmount_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ConfirmPrice")]
        public decimal PercentConfirmAmount { get; set; }
        public decimal PercentConfirmAmount_OverrideForStore { get; set; }


        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.TermsAndConditions")]
        public string TermsAndConditions { get; set; }
        public string TermsAndConditions_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.OrderSteps")]
        public string OrderSteps { get; set; }
        public string OrderSteps_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.DeliveryPrice")]
        public decimal DeliveryAmount { get; set; }
        public decimal DeliveryAmount_OverrideForStore { get; set; }
