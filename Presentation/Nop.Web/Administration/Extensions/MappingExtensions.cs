...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static ZipcodeModel ToModel(this Zipcodes entity)
        {
            return entity.MapTo<Zipcodes, ZipcodeModel>();
        }

        public static Zipcodes ToEntity(this ZipcodeModel model)
        {
            return model.MapTo<ZipcodeModel, Zipcodes>();
        }

        public static Zipcodes ToEntity(this ZipcodeModel model, Zipcodes destination)
        {
            return model.MapTo(destination);
        }
