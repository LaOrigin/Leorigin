...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public ActionResult Category(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            int PageSize = 9;
            int OrderBYId = command.OrderBy == 0 ? (int)ProductSortingEnum.Position : command.OrderBy;
            var products = _productService.SearchProducts(out filterableSpecificationAttributeOptionIds, true,
                ...
                orderBy: (ProductSortingEnum)OrderBYId,
        ...
        [HttpPost]
        public JsonResult GetProductsWithScroll(int page, int categoryId, string viewmode, int OrderBy)
        {
            ...
            IList<int> filterableSpecificationAttributeOptionIds;
            int PageSize = 9;
            int OrderBYId = OrderBy == 0 ? (int)ProductSortingEnum.Position : OrderBy;
            var products = _productService.SearchProducts(out filterableSpecificationAttributeOptionIds, true,
              categoryIds: categoryIds,
              storeId: _storeContext.CurrentStore.Id,
              visibleIndividuallyOnly: true,
            ...
            var output = RenderProductview(model);
        ...
        public static string PartialViewdata(Controller controller, string viewName, object model)
        {
