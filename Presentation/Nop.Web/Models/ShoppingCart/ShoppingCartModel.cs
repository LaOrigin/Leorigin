...
namespace Nop.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNopModel
    {
        public ShoppingCartModel()
        {
            ...
            DecorItems = new List<ShoppingCartItemModel>();
            NonDecorItems = new List<ShoppingCartItemModel>();
        ...
        public IList<ShoppingCartItemModel> DecorItems { get; set; }
        public IList<ShoppingCartItemModel> NonDecorItems { get; set; }
