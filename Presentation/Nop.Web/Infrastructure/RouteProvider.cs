    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("CheckoutSelectBillingAddress",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CheckoutDeleteBillingAddress",
                            "checkout/Deletebillingaddress",
                            new { controller = "Checkout", action = "DeleteBillingAddress" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CheckoutShippingMethod",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //Nyusoft start
            routes.MapLocalizedRoute("CheckoutConfirmAddress",
                           "checkout/confirmaddress",
                           new { controller = "Checkout", action = "ConfirmAddress" },
                           new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CheckoutPaymentTransactionInfo",
                           "checkout/paymentprogress",
                           new { controller = "Checkout", action = "PaymentInfoTransaction" },
                           new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CategoryN",
                           "{controller}/{action}/{page}/{categoryId}",
                           new { controller = "Catalog", action = "Idnex", id = UrlParameter.Optional, categoryId = UrlParameter.Optional });

            //Advance Amount Logic
            routes.MapLocalizedRoute("checkouttransactionconfirm",
                      "checkout/checkouttransactionconfirm",
                      new { controller = "Checkout", action = "ConfirmOrderTransaction" },
                      new[] { "Nop.Web.Controllers" });

          
            routes.MapLocalizedRoute("selectPaymentMethodOrderDetail",
                      "checkout/selectPaymentMethodOrderDetail",
                      new { controller = "Checkout", action = "SelectTransactionPaymentMethod" },
                      new[] { "Nop.Web.Controllers" });

            //Return
            routes.MapLocalizedRoute("Plugin.Payments.Payu.Return",
                 "PaymentPayu/Return",
