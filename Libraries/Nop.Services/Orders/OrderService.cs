...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        private readonly IRepository<OrderTransactionDetails> _orderTransactionDetailRepository;
        ...
        public OrderService(IRepository<Order> orderRepository,
            IRepository<OrderTransactionDetails> orderTransactionDetailRepository,
            ...
            IEventPublisher eventPublisher)
        {
            ...
            this._orderTransactionDetailRepository = orderTransactionDetailRepository;
        ...
        public virtual OrderTransactionDetails GetOrderByTxnId(Guid orderId)
        {
            if (orderId == Guid.Empty)
                return null;

            var query = from o in _orderTransactionDetailRepository.Table
                        where o.TransactionId == orderId.ToString()
                        select o;
        ...
        /// </summary>
        /// <param name="order">The order</param>
        public virtual void UpdateOrderTransactionDetail(OrderTransactionDetails order)
        {
            if (order == null)
                throw new ArgumentNullException("order");

            _orderTransactionDetailRepository.Update(order);
