            ...
            try
            {
                ...
                if (processPaymentResult.Success)
                {
                    ...
                    //using (var scope = new System.Transactions.TransactionScope())
                    {
                        ...
                        var advanceTotal = _orderTotalCalculationService.GetCartAdvanceTotal(cart);
                        var orderPaymentInfo = new OrderTransactionDetails()
                        {
                           TransactionAmount = advanceTotal.Value,
                        ...
                        order.TotalTransactionAmount = advanceTotal.Value;
                        order.OrderTransactionDetailItems.Add(orderPaymentInfo);
                        _orderService.UpdateOrder(order);
