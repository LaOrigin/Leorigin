...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        private ICollection<OrderTransactionDetails> _orderTransactionDetailItems;
        ...
        /// <summary>
        /// Gets or sets the Total Amount for Transactions
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets order Transaction Details items
        /// </summary>
        public virtual ICollection<OrderTransactionDetails> OrderTransactionDetailItems
        {
            get { return _orderTransactionDetailItems ?? (_orderTransactionDetailItems = new List<OrderTransactionDetails>()); }
            protected set { _orderTransactionDetailItems = value; }
        }
