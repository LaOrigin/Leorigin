...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<City> _cityApplied;
        ...
        public virtual ICollection<City> CityApplied
        {
            get { return _cityApplied ?? (_cityApplied = new List<City>()); }
            protected set { _cityApplied = value; }
        }
        /// <summary>
